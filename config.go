...
type loggingConfig struct {
	Level   string        `json:"level" flag:"log-level,info,log level"`
	Syslog  syslogConfig  `json:"syslog"`
	Console consoleConfig `json:"console"`
}

type consoleConfig struct {
	Enabled   bool `json:"enabled" flag:"log-console,true,send log on console"`
	Pretty    bool `json:"pretty" flag:"log-console-pretty,,enable pretty log on console"`
	UseStderr bool `json:"use_stderr" flag:"log-console-stderr,,send logs on stderr"`
}

type syslogConfig struct {
	Enabled  bool   `json:"enabled" flag:"log-syslog,,send log with syslog"`
	Facility string `json:"facility" flag:"log-syslog-facility,local0,syslog facility to use"`
}
